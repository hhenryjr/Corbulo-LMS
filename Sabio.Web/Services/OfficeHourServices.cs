...
namespace Sabio.Web.Services
{
    public class OfficeHourServices : BaseService, IOfficeHourServices
    {
        ...
        public void AddQuestionResponse(OfficeHourQuestionsUpdateRequest model, int oId, int Id)
        {
            DataProvider.ExecuteNonQuery(GetConnection, "dbo.OfficeHourQuestions_AddUpdateResponse",
                inputParamMapper: delegate(SqlParameterCollection parametercollection)
                           {
                    parametercollection.AddWithValue("@Id", Id);
                    parametercollection.AddWithValue("@OfficeHourId", oId);
                    parametercollection.AddWithValue("@Response", model.Response);
                           });
        }
        ...
        {
            DataProvider.ExecuteNonQuery(GetConnection, "dbo.OfficeHourQuestions_DeleteById",
                inputParamMapper: delegate(SqlParameterCollection paramCollection)
                {
                    paramCollection.AddWithValue("@Id", id);
                });
